...
--execute usp_GetInvoiceDetails_test 8125,'adoptive_parent'
--execute usp_GetInvoiceDetails_test 981,'adoptive_parent'
--execute usp_GetInvoiceDetails_test 9413,'adoptive_parent'
--execute usp_GetInvoiceDetails_test 17169,'adoptive_parent'


--EXEC usp_GetInvoiceDetails_test
--									 @user_id=8125
...
GO
IF exists (select 1 from sys.objects where name='usp_GetInvoiceDetails_test' and type='p')
DROP PROCEDURE usp_GetInvoiceDetails_test;

GO

CREATE PROCEDURE usp_GetInvoiceDetails_test
(  
  @user_id				INT
