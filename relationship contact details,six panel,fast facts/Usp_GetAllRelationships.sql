...
EXEC Usp_GetAllRelationships '164','-59818','-59817',
 '132044', '-101'
 EXEC Usp_GetAllRelationships '164','-94037','',
 '348435', ''
  ...
  If @ConnId2 <> 0
   ...
   If @PgmConnectionId <> 0
	...
	SET Connid_FastFacts=CASE 
						 ...
						 WHEN RelationshipSubTypeText COLLATE DATABASE_DEFAULT in 
						 (select RelationshipSubTypeText from rel_lkp_relationshipsubtype 
						  where Rel_SubType_isProgram=1)
	...
	SET Connid_FastFacts=CASE 
						 ...
						 WHEN Connid_FastFacts<=0

						 THEN Connid_FastFacts

						 ELSE -(Connid_FastFacts)
