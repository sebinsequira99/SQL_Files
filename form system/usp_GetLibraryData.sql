...
BEGIN
 ...
 ('scope','program_id','connection_id','is_system') Order By ID
 ...
 left join #xmldata_system xs on xi.inputfieldvalue = xs.systemfieldname
 left join #xmlData_custom xc on xi.inputfieldvalue=xc.Customfieldname
